...
import { ClientSelectorComponent } from '../client-selector/client-selector/client-selector.component';
...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  loading = false;
  returnUrl = 'pages/first-dashboard-view/list';
  ...
  constructor(
    private router: Router, private authService: AuthService, private alertService: AlertService, private storeService: StoreCoreService,
  ...
  getClinicForModal(data) {
    ...
    this.router.navigate(['pages/first-dashboard-view/list']);
    // } 
  ...
  popClinicSelection() {
    ...
    //     this.bsModalRef = this.modalService.show(ClientSelectorComponent, {
    //       initialState,
    //       class: 'modal-x-lg',
    //       backdrop: 'static',
    //       keyboard: false
