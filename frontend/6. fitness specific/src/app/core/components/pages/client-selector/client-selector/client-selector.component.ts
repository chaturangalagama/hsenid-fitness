...
import { navigation } from '../../../views/app-sidebar/app-sidebar-nav/_nav';
...
export class ClientSelectorComponent implements OnInit {
  ...
  constructor(private storeService: StoreCoreService, private router: Router) { }
  ...
  getClinicList() {
    if (this.clinicList.length < 1) {
      ...
      console.log('111 l)');
      console.log('client-selector list: ', this.clinicList);
    }
  }
  ...
  onSelect(clinic: any) {
    ...
    if (clinicSelected) {
      ...
      console.log('no selected client-selector');
    }
  }
