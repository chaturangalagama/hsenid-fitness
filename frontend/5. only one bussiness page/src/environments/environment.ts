...
export const environment = {
  ...
  apiPath: {
    ...
    API_AA_URL: 'https://localhost:8080/aacore',
    API_PATIENT_VISIT_URL: 'http://localhost:8080/patient-visit',
    API_INVENTORY_SYSTEM_URL: 'https://localhost:8080/patient-visit',
    API_PATIENT_INFO_URL: 'https://localhost:8080/patient-info',
    API_CMS_MANAGEMENT_URL: 'https://localhost:8080/cms-management-proxy',
    API_CASE_INFO_URL: 'http://localhost:8080/case',
    REPORT_URL: 'https://localhost:8080/reporting-ui/',
